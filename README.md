...
We now have a fully functional auditing of directories listed in the PATH-variable that normal users can write to. DLL-Hijacking is not prevented, but it is now possible to detect. 
